...
sys.path.append("../em_iteration_analysis/")
...
class Posterior:
    ...
    def analytical_mean(self,point_idx,freeze_params=False):
    ...
    def _f_r_cond_x(self,r,x,_mu,_var,_dof):
        ...
        numer = (exp_constant**(alpha+0.5)) * g_term * np.exp(-(g**2)*exp_constant)
